...
declare class Game<G = Gamedatas> {
  /**
   ...
   */
  ajaxcall(url: string, args: object, bind: Game, resultHandler: (result: any) => void, allHandler?: (err: any, result?: any) => void): void;
...
declare class Stock {
    ...
    create(game: Game, container_div: HTMLDivElement, cardwidth: number, cardheight: number): void;
